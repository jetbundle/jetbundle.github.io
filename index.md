...
<div class="hero-container" style="text-align: center; padding: 4rem 0;">
  ...
  <div class="cta-group" style="margin-top: 3rem;">
    <a href="https://discord.gg/5mbumWNb5U" class="btn btn-primary" style="border: 1px solid #e5e5e5; padding: 10px 20px; text-decoration: none; color: #ffffff !important; margin-right: 15px; text-transform: uppercase; font-size: 0.9rem; font-weight: bold; transition: color 0.2s ease;">Join Discord</a>
    <a href="https://github.com/jetbundle" class="btn btn-secondary" style="border: 1px solid #333; padding: 10px 20px; text-decoration: none; color: #ffffff !important; text-transform: uppercase; font-size: 0.9rem; font-weight: bold; transition: color 0.2s ease;">View GitHub</a>
  </div>
  <style>
