...
- **Cryptography (The "Enigma"):** Funded by intelligence agencies ("CIA, KGB and the like"), this pillar generated the demand for number theory, algebraic geometry over finite fields, and algebra.

- **Hydrodynamics (The "Submarine"):** Supported by "manufacturers of atomic submarines," this pillar procreated complex analysis, partial differential equations, and scientific computing.

- **Celestial Mechanics (The "Missile"):** Financed by "institutions dealing with missiles, such as NASA," this pillar was the origin of dynamical systems, linear algebra, topology, and variational calculus.
...
- **Operating Systems:** The modern OS is a direct descendant of the 1960s military requirement for a "Survivable SAC command net". J.C.R. Licklider, as director of DARPA's IPTO, executed this mandate by funding MIT's **Project MAC**—the project that built **Multics**, the ancestor of all modern OS. This 60-year institutional lineage is unbroken: the "Modern Patron" is the same DoD, which now leases this "computer utility" from Microsoft, whose **Azure Kubernetes Service** is formally authorized for **DoD Impact Level 5 (IL5)** workloads.

- **Artificial Intelligence:** The 1980s neural net revival was funded by ONR and DARPA. The "Killer App" was **ALVINN** (Autonomous Land Vehicle In a Neural Network), a 3-layer backpropagation network built to drive an autonomous HUMVEE. The "Modern Patrons," **Palantir** and **Anduril**, are operationalizing this 1980s R&D for AI-driven drone swarms and targeting systems.
...
- **Missile Guidance → Time-Series Analysis:** The **Kalman Filter** was funded by the AFOSR in 1954 and was the "essential" GNC tool for the Apollo program's mid-course corrections and the Minuteman-III ICBM. This is the *exact* math taught in `AMS 578: Regression Theory` and is now the quintessential tool for filtering a "true" asset signal from "noisy" market data.
...
- **The "Migratory App":** A "killer app" migrates across academic disciplines, pulled by patronage. The **Kalman Filter** is the archetype.
  1. **Probability (ONR):** Funded as a *probabilistic* tool for SONAR contact tracking.
  2. **Dynamical Systems (NASA):** Adopted as a *navigational* tool for Apollo.
  3. **Linear Algebra (ARO):** Funded as a *computational* tool for the Minuteman-III.

- **The "18-Year Lag":** This is the "declassification by syllabus."
  1. **The "Memo" (c. 1978):** Leslie Lamport's **Byzantine Generals Problem** is created as an explicit parable for a DARPA C3 (Command, Control, Communications) requirement: a survivable nuclear command network.
  2. **The "Lemma" (c. 1999):** Lamport wins the Turing Award, cementing the problem as a "pure," abstract concept in distributed systems.
  3. **The "Syllabus" (c. 2017):** The problem appears in the MIT 6.033 syllabus, its nuclear-war origins fully redacted.
...
- **The Archive** contains the declassified memos, booklists, and primary sources.
- **The Audits** apply this forensic methodology to new fields.
